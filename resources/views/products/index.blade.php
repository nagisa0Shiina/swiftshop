...
<section class="bg-white py-12 sm:py-16 md:py-20 overflow-hidden">

    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-14">

        {{-- ShopSwiftのこだわり --}}
        <section class="py-4 sm:py-8 md:py-10">
        ...
        {{-- はじめての方へ --}}
        <section class="py-4 sm:py-8 md:py-10">
            <div class="rounded-[1.75rem] sm:rounded-[2rem] border border-[#e8dccb] bg-[#f8f1e8] p-5 sm:p-8 md:p-12 lg:p-16 overflow-hidden">
                ...
                <div class="md:hidden space-y-5">
                    ...
                    <div class="rounded-[1.75rem] bg-white border border-white shadow-sm overflow-hidden">
                        <div class="relative">
                            ...
                            <div class="absolute top-4 left-4 w-11 h-11 rounded-full bg-[#75885d] text-white flex items-center justify-center text-lg font-bold shadow-md">
                                1
                            </div>
                        </div>
                    ...
                    <div class="rounded-[1.75rem] bg-white border border-white shadow-sm overflow-hidden">
                        <div class="relative">
                            ...
                            <div class="absolute top-4 left-4 w-11 h-11 rounded-full bg-[#c98962] text-white flex items-center justify-center text-lg font-bold shadow-md">
                                2
                            </div>
                        </div>
                    ...
                    <div class="rounded-[1.75rem] bg-white border border-white shadow-sm overflow-hidden">
                        <div class="relative">
                            ...
                            <div class="absolute top-4 left-4 w-11 h-11 md:top-4 md:left-4 rounded-full bg-[#d98b65] text-white flex items-center justify-center text-lg font-bold shadow-md">
                                3
                            </div>
                        </div>
    ...
    <div class="relative overflow-hidden min-h-[620px]">
        ...
        <div class="relative z-10 px-5 sm:px-8 lg:px-12 py-12 sm:py-16">
            {{-- 左ボタン：カード外・画像端 --}}
                    ...
                    type="button"
                    id="ssBenefitPrev"
                    class="absolute -left-3 sm:left-10 lg:left-8 top-1/2 -translate-y-1/2 z-50 w-12 h-12 rounded-full bg-[#f3f4f6]/90 border border-gray-200 shadow flex items-center justify-center hover:bg-white"
                    aria-label="前へ"
                >
                ...
                <button
                    type="button"
                    id="ssBenefitNext"
                    class="absolute -right-3 sm:right-10 lg:right-8 top-1/2 -translate-y-1/2 z-50 w-12 h-12 rounded-full bg-[#f3f4f6]/90 border border-gray-200 shadow flex items-center justify-center hover:bg-white"
                    aria-label="次へ"
                >
