                ...
                <div class="md:hidden space-y-5">
                    ...
                    <div class="rounded-[1.75rem] bg-white border border-white shadow-sm overflow-hidden">
                        <div class="relative">
                            ...
                            <div class="absolute top-4 left-4 w-11 h-11 rounded-full bg-[#d98b65] text-white flex items-center justify-center text-lg font-bold shadow-md">
                                3
                            </div>
                        </div>
    ...
    <div class="relative overflow-hidden min-h-[620px]">
        ...
        <div class="relative z-10 px-5 sm:px-8 lg:px-12 py-12 sm:py-16">
            ...
            <button
                type="button"
                id="ssBenefitPrev"
                class="absolute left-4 sm:left-10 lg:left-8 top-1/2 -translate-y-1/2 z-50 w-12 h-12 rounded-full bg-[#f3f4f6]/70 border border-gray-200 shadow flex items-center justify-center hover:bg-white"
                aria-label="前へ"
            >
            ...
            <button
                type="button"
                id="ssBenefitNext"
                class="absolute right-4 sm:right-10 lg:right-8 top-1/2 -translate-y-1/2 z-50 w-12 h-12 rounded-full bg-[#f3f4f6]/70 border border-gray-200 shadow flex items-center justify-center hover:bg-white"
                aria-label="次へ"
            >
