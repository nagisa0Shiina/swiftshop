...
<div class="min-h-screen flex">
    ...
    <aside class="hidden lg:flex w-[300px] shrink-0 min-h-screen flex-col bg-[#070d16] text-white">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
            ...
            <a href="{{ Route::has('admin.shipping.index') ? route('admin.shipping.index') : route('admin.orders.index') }}" class="flex flex-row items-center gap-4 rounded-2xl px-5 py-4 text-base font-bold whitespace-nowrap text-white/80 hover:bg-white/10 hover:text-white transition">
                <i data-lucide="truck" class="w-5 h-5 shrink-0"></i><span>発送状況</span>
            </a>

            <a href="{{ Route::has('admin.payments.index') ? route('admin.payments.index') : route('admin.orders.index') }}" class="flex flex-row items-center gap-4 rounded-2xl px-5 py-4 text-base font-bold whitespace-nowrap bg-white text-[#070d16] transition">
