...
<head>
    ...
    <title>記事編集 | ShopSwift Admin</title>
        ...
        <form method="POST"
            ...
            <div class="xl:col-span-2 bg-white border border-gray-200 rounded-2xl p-5 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="excerpt"
                              rows="3"
                              class="w-full border rounded-xl px-4 py-4 text-base resize-y @error('excerpt') border-red-500 bg-red-50 @enderror">{{ old('excerpt', $article->excerpt) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="body"
                              rows="14"
                              class="w-full border rounded-xl px-4 py-4 text-base leading-relaxed resize-y @error('body') border-red-500 bg-red-50 @enderror">{{ old('body', $article->body) }}</textarea>
            ...
            <aside class="bg-white border border-gray-200 rounded-2xl p-5 sm:p-8 h-fit space-y-6 xl:sticky xl:top-8">
                ...
                <div>
                    ...
                    <div class="w-full aspect-video bg-gray-100 rounded-2xl overflow-hidden flex items-center justify-center mb-4">
