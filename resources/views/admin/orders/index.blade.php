                    ...
                    @forelse ($orders as $order)
                        ...
                        <tr class="border-b border-gray-200 last:border-b-0 hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-7 whitespace-nowrap">
                                <span class="inline-flex px-4 py-2 rounded-full {{ $paymentClass }} font-bold text-sm">
                                    {{ $paymentLabel }}
                                </span>
                            </td>

                            <td class="px-6 py-7 whitespace-nowrap">
                                <span class="inline-flex px-4 py-2 rounded-full {{ $shippingClass }} font-bold text-sm">
                                    {{ $shippingLabel }}
                                </span>
                            </td>
                            ...
                            <td class="px-6 py-7 whitespace-nowrap">
                                <div class="flex items-center justify-end gap-3">
                                    ...
                                    <form method="POST"
                                          ...
                                          onsubmit="return confirm('この注文を削除しますか？削除すると、発送状況・決済状況・ダッシュボードの最近の注文にも表示されなくなります。');">
                                        @csrf
                                        @method('DELETE')
