                        ...
                        <div>
                            ...
                            <form method="POST"
                                ...
                                <select name="shipping_status"
                                    ...
                                    <option value="preparing" @selected($order->shipping_status === 'preparing')>
                                        発送準備中
                                    </option>

                                    <option value="shipping" @selected($order->shipping_status === 'shipping')>
                                        発送中
                                    </option>

                                    <option value="completed" @selected($order->shipping_status === 'completed')>
                                        配送完了
                                    </option>
                                </select>
                ...
                <table class="min-w-[1200px] w-full">
                    ...
                    <thead class="bg-gray-50 border-b">
                        <tr class="text-left text-sm text-gray-500">
                            ...
                            <th class="px-6 py-4">配送先</th>
                            <th class="px-6 py-4">発送状況</th>
